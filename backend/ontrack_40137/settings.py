"""
Django settings for ontrack_40137 project.
...
ROOT_URLCONF = 'ontrack_40137.urls'
...
WSGI_APPLICATION = 'ontrack_40137.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ontrack_40137 API",
    "DESCRIPTION": "API documentation for ontrack_40137 App",
    "VERSION": "v1",
}
